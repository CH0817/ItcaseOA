...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--頁面標題-->
            <img border="0" width="13" height="13" src="${pageContext.request.contextPath}/style/images/title_arrow.gif"/> 帖子回復
        </div>
		...
		<center>
			...
			<div class="ItemBlockBorder">
				<table border="0" cellspacing="1" cellpadding="1" width="100%" id="InputArea">
					<tr>
						<td class="InputAreaBg" height="30" width="80px"><div class="InputTitle">帖子主題</div></td>
					...
					<tr>
						...
						<td class="InputAreaBg"><div class="InputContent">
							<s:textfield name="title" cssClass="InputStyle" cssStyle="width:100%" value="回復：%{#topic.title}"/></div>
						</td>
					</tr>
					<tr height="240">
