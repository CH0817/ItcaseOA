			...
			<div id="CenterArea">
				...
				<div id="LoginInfo">
					<table BORDER=0 CELLSPACING=0 CELLPADDING=0 width=100%>
						<tr>
							<td colspan="3">
								<!-- 顯示錯誤 --> <font color="red"><s:fielderror /></font>
							</td>
						</tr>
						<tr>
							<td width=45 class="Subject"><img border="0" src="${pageContext.request.contextPath}/style/blue/images/login/userId.gif" /></td>
							<td><s:textfield name="loginName" size="20" tabindex="1" cssClass="TextField required" id="loginNameInput" /></td>
				...
				<div id="CopyRight">
					<a href="javascript:void(0)">&copy; 2010 版權所有 itcast</a>
				</div>
			</div>
		</div>
	</s:form>
