			...
			<td align=center>
				<div id=Logout>
					...
					<div id=LogoutOperate>
                        ...
                        <a href="${pageContext.request.contextPath}/user_loginUI.action">重新進入系統</a> 
                        <img src="${pageContext.request.contextPath}/style/blue/images/logout/logout3.gif" border=0> 
                        <a href="javascript: window.open('','_self');window.close();">關閉當前窗口</a>
                    </div>
				</div>
			</td>
		</tr>
